...
class FirebaseChatCore {
  ...
  Future<types.Room> createGroupRoom({
    ...
    final currentUserData = await fetchUser(
    ...
    final roomUsers = [types.User.fromJson(currentUserData)] + users;
  ...
  Future<types.Room> createRoom(
    ...
    final users = [types.User.fromJson(currentUserData), otherUser];
  ...
  Stream<types.Room> room(String roomId, MyProfile currentUser) {
  ...
  Stream<List<types.Room>> rooms(MyProfile currentUser,
  ...
  /// does nothing.
  void sendMessage(
      dynamic partialMessage, String roomId, MyProfile currentUser) async {
  ...
  Stream<List<types.User>> users(MyProfile currentUser) {
    return getFirebaseFirestore()
        .collection(config.usersCollectionName)
        .snapshots()
        .map(
