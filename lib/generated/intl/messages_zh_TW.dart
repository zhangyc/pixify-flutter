...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "continueWithEmail": MessageLookupByLibrary.simpleMessage("使用電子郵件繼續"),
    "continueWithGoogle": MessageLookupByLibrary.simpleMessage("使用Google繼續"),
    "continueWithPhone": MessageLookupByLibrary.simpleMessage("使用電話繼續"),
    ...
    "exampleLabel": MessageLookupByLibrary.simpleMessage("範例"),
    ...
    "hereSonaCookedUpForU": MessageLookupByLibrary.simpleMessage("這是SONA為你特製的"),
    ...
    "letSONASayHiForYou": MessageLookupByLibrary.simpleMessage("讓SONA代你打招呼"),
    "likedPageMonetizeButton": MessageLookupByLibrary.simpleMessage("查看他們的資料"),
    ...
    "onboardingB": MessageLookupByLibrary.simpleMessage("減輕社交壓力\n與全球的趣味靈魂一起放鬆"),
    ...
    "permissionRequiredContent": MessageLookupByLibrary.simpleMessage(
      "Sona需要您的位置信息才能正常工作。您需要在手機設置中打開位置訪問權限",
    ),
    ...
    "plusPerkDuoSnap": MessageLookupByLibrary.simpleMessage("每週10次Duo Snap"),
    ...
    "recordsLabel": MessageLookupByLibrary.simpleMessage("紀錄"),
    ...
    "requireYourRealPhoto": MessageLookupByLibrary.simpleMessage("合照需要你的真實照片"),
    ...
    "soloLabel": MessageLookupByLibrary.simpleMessage("單人"),
    ...
    "sonaWillGenerateABioBasedOnInterests":
        MessageLookupByLibrary.simpleMessage("SONA會根據你的興趣生成一份簡介"),
    ...
    "warningUnmatching": MessageLookupByLibrary.simpleMessage(
      "取消配對後，你們之間的聊天內容都將被清除。",
    ),
    "weeklyLimitReached": MessageLookupByLibrary.simpleMessage("本周次数已用完"),
    "whatsYourEmail": MessageLookupByLibrary.simpleMessage("輸入郵箱"),
