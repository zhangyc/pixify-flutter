...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "cantMergePhotos":
            MessageLookupByLibrary.simpleMessage("对方没有真实照片，暂时不能进行合影哦"),
        ...
        "clubPerkSonaMessage":
            MessageLookupByLibrary.simpleMessage("每天100条SONA消息（免费的3倍）"),
        "clubPerkSonaTip": MessageLookupByLibrary.simpleMessage("每天5次SONA建议"),
        "clubPromotionContent":
            MessageLookupByLibrary.simpleMessage("抓住这个交易 - 加入俱乐部并大放异彩！"),
        ...
        "photoMightNotBeReal":
            MessageLookupByLibrary.simpleMessage("双人快照可能会很奇怪，因为对方的照片可能不是真的"),
        ...
        "requireYourRealPhoto":
            MessageLookupByLibrary.simpleMessage("合影需要你的真实照片"),
        ...
        "wishCountryPickerTitle":
            MessageLookupByLibrary.simpleMessage("你 对哪个国家更感兴趣？"),
